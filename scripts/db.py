...
if _use_postgres:
    from scripts.postgres_utils import (
        ...
        get_hands, get_hands_stats, save_hand, get_hands_by_ids,
        ...
        get_admin_summary, get_admin_users, get_admin_analytics, delete_admin_user,
        is_firebase_enabled, get_db,
        get_analysis_hands_for_3d,
    )
else:
    ...
    def get_hands_by_ids(uid: str, hand_ids: list) -> list:
        return []
    def get_analysis_hands_for_3d(uid: str, job_id: str) -> list:
        return []

...
```
Day 1 (2026-05-17): WeasyPrint移行・コード作業・本番デプロイ・PDF動作確認  ✅ 完了
Day 2 (2026-05-17): ドメイン取得（hrep.app）                               ✅ 完了
Day 2 (2026-05-18): EC2セットアップ・IAMロール・RDS接続許可                ✅ 完了
                    EC2: i-06c53e45fc140cb9c / IP: 13.158.136.15 (t3.micro, ap-northeast-1)
